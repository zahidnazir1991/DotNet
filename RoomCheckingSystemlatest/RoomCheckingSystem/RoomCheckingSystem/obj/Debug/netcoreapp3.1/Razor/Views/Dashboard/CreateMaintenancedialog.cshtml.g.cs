#pragma checksum "D:\Home\workspace\RoomCheckingSystemlatest\RoomCheckingSystem\RoomCheckingSystem\Views\Dashboard\CreateMaintenancedialog.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "71af213452905876041a8c8600bb26771c4a2cf1"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"71af213452905876041a8c8600bb26771c4a2cf1", @"/Views/Dashboard/CreateMaintenancedialog.cshtml")]
 ...
 ");
    ...
    function loadparentStatus() {
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function (d) {
                var s = '<option value=""-1"">--Select main sta");
            WriteLiteral(@"tus--</option>';
            ...
            success: function (d) {
                ...
                for (var i = 0; i < d.length; i++) {
                    ...
                    if (d[i].intSeqID == ChildStatus) {
                        ...
                        s += '<option style=""color:' + d[i].color + '"" value=""' + d[i].intSeqID + '"" isprority=""' + d[i].isPriority + '"" isCheckoutTime=""' + d[i].isCheckout");
            WriteLiteral(@"Time + '"">' + d[i].text + '</option>';
