#pragma checksum "D:\Home\workspace\RoomCheckingSystemlatest\RoomCheckingSystem\RoomCheckingSystem\Views\Dashboard\CreateMaintenancedialog.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c0275588a12d58e4458f59aaa1b4f440465d0a9e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c0275588a12d58e4458f59aaa1b4f440465d0a9e", @"/Views/Dashboard/CreateMaintenancedialog.cshtml")]
...
#line 34 "D:\Home\workspace\RoomCheckingSystemlatest\RoomCheckingSystem\RoomCheckingSystem\Views\Dashboard\CreateMaintenancedialog.cshtml"
               Write(Html.DropDownListFor(model => model.intChildStatus, ViewBag.proritylist as SelectList, new { @id = "ChildStatus_1", @class = "form-control" }));
...
#nullable disable
        ...
        <div class=""form-group"">
            ");
#nullable restore
#line 45 "D:\Home\workspace\RoomCheckingSystemlatest\RoomCheckingSystem\RoomCheckingSystem\Views\Dashboard\CreateMaintenancedialog.cshtml"
       Write(Html.TextAreaFor(m => m.Description, new { @Value = "12", @id = "texdes_1", required = "required", disabled = "disabled", @class = "form-control removeshadow", autocomplete = "off", placeholder = "Type job description..." }));
...
#nullable restore
#line 51 "D:\Home\workspace\RoomCheckingSystemlatest\RoomCheckingSystem\RoomCheckingSystem\Views\Dashboard\CreateMaintenancedialog.cshtml"
...
");
            WriteLiteral(@"            document.getElementById(""tvpro"").style.display = ""none"";
            ...
            success: function (d) {
                ...
                for (var i = 0; i < d.length; i++) {
                    ...
                    if (d[i].intSeqID == ChildStatus) {
                        ...
                        s += '<option style=""color:' + d[i].color + '"" value=""' + d[i].intSeqID + '");
            WriteLiteral(@""" isprority=""' + d[i].isPriority + '"" isCheckoutTime=""' + d[i].isCheckoutTime + '"">' + d[i].text + '</option>';
