   ...
   .ToList();
    ...
    .ToList();
        ...
        public void SaveImage(string base64img, string outputImgFilename = "image.jpg")
        {
            ...
            System.IO.File.WriteAllBytes(Path.Combine(folderPath, outputImgFilename), Convert.FromBase64String(convert));
        }

        public JsonResult saveChat(int? statusID, int? GroupID, int? type, int? roomId, int? buildingID,string description,String base64string)
        {
            string imagename = "";
            if (base64string != null && base64string != "")
            {
                ...
                SaveImage(base64string, imagename);
            }
